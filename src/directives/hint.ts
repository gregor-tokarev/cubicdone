...
export const hint: Directive = {
    mounted(el, binding) {
        ...
        tooltip.className = 'flex absolute py-0.5 px-1.5  transition-opacity rounded-lg bg-[#292929] translate-x-[10px] text-gray-300 text-xs';

        tooltip.innerHTML = binding.value;
        tooltip.insertAdjacentHTML('afterbegin', `<svg class="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-[4px]" width="6" height="7" viewBox="0 0 6 7" fill="none" xmlns="http://www.w3.org/2000/svg">
