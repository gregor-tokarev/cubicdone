...
<template>
    <div class="flex cursor-grab items-start space-x-2 rounded-lg bg-gray-100 px-4 py-2.5 transition-colors hover:bg-gray-50 active:cursor-grabbing border-2 border-transparent"
        :class="{
            'opacity-50 hover:!bg-gray-100': task.status === 'done',
            'bg-gray-50': hovered,
