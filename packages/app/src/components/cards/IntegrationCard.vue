...
<template>
    <div class="flex flex-col rounded-lg border" :class="{
        ...
        <div class="p-5 pb-8">
            <div class="flex items-center space-x-2.5">
                <div class="flex items-center space-x-2">
                    <img :src="integration.iconURL" class="!h-6 !w-6 object-contain" alt="icn" />
        ...
        <div class="mt-auto flex cursor-pointer select-none items-center justify-center space-x-1 border-t py-4" :class="{
            'border-gray-300': !integration.apiKeys.length,
            'border-black': integration.apiKeys.length,
        }" @click="onClickAction">
