...
<template>
    <div class="flex w-[250px] flex-col rounded-br-2xl rounded-tr-2xl bg-black px-[18px] py-4"
        ...
        <!--    title block-->
        <div class="relative flex items-center justify-between h-[38px]">
        ...
        <div class="mt-auto flex cursor-pointer items-center space-x-2 rounded from-[#1A1A1A] to-[#141414] px-1.5 py-2 text-base text-gray-200 transition-colors hover:bg-gradient-to-r hover:text-white h-[32px]"
            :class="{
                'h-unset w-full': !compact,
